...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
                                  ...
                                  children: [
                                    DropdownButtonFormField<String>(
                                      ...
                                      items: sttModels
                                          ...
                                          .toList(),
                                      onChanged:
                                          settings.isBusy || sttModels.isEmpty
                                              ? null
                                              : (value) {
                                                  _sttModel = value;
                                                  _sttModelDirty = true;
                                    ...
                                    DropdownButtonFormField<String>(
                                      ...
                                      items: ttsModels
                                          ...
                                          .toList(),
                                      onChanged:
                                          settings.isBusy || ttsModels.isEmpty
                                              ? null
                                              : (value) {
                                                  _ttsModel = value;
                                                  _ttsModelDirty = true;
                              ...
                              LayoutBuilder(
                                builder: (context, constraints) {
                                  ...
                                  return Align(
                                    ...
                                    child: SizedBox(
                                      width:
                                          expandAction ? double.infinity : null,
                                      child: FilledButton.icon(
                                        ...
                                        icon: SizedBox.square(
                                          key:
                                              const Key('settingsSaveIconSlot'),
                                          dimension: 24,
                                          child: Center(
                                            child: isSaving
                                                ? SizedBox.square(
    ...
    try {
      ...
      if (mounted) {
        ...
        final nextStt = _selectionAfterFetch(
          catalog.stt,
          useLiveDesktopModels ? current.sttModel : _sttModel,
        );
        final nextTts = _selectionAfterFetch(
          catalog.tts,
          useLiveDesktopModels ? current.ttsModel : _ttsModel,
        );
        if (useLiveDesktopModels) {
          if (nextStt != null) {
        ...
        setState(() {
          _sttModelDirty = !useLiveDesktopModels && nextStt != _sttModel;
          _ttsModelDirty = !useLiveDesktopModels && nextTts != _ttsModel;
          _sttModel = nextStt;
          _ttsModel = nextTts;
        });
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _submit({required bool testConnection}) async {
    ...
    try {
      ...
      final sttModel =
          useLiveDesktopModels ? currentSettings.sttModel : (_sttModel ?? '');
      final ttsModel =
          useLiveDesktopModels ? currentSettings.ttsModel : (_ttsModel ?? '');
